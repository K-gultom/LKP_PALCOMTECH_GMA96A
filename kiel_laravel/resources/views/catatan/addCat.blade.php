        ...
        <div class="row">
            <div class="col">
                ...
                <nav aria-label="breadcrumb" class="mb-1">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item active" aria-current="page"><a href="{{ url('/jadwal') }}">Data Catatan</a></li>
                    ...
                    <div class="card-header">
                        <div class="d-flex">
                            <div class="w-100 pt-1">
                                <strong>Tambah Catatan</strong> saya
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-5">
                                    <div class="form-outline">
                                        ...
                                        <input type="text" placeholder="Tulis judul catatan Anda..." name="judul" id="judul" class="form-control @error('judul') is-invalid @enderror">
                                        @error('judul')
                                            <div class="invalid-feedback">
                                                {{ $message }}
                                            </div>
